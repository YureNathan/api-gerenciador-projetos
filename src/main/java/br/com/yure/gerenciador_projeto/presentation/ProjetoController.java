...
public class ProjetoController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "buscar Projeto por Id", description = "Método para buscar um projeto por Id!")
    ...
    @GetMapping
    @Operation(summary = "Listar todos os Projeto", description = "Método para listar todos os projeto!")
    ...
    @PostMapping
    @Operation(summary = "Criar Projeto", description = "Método para criar um projeto!")
    ...
    @Operation(summary = "Iniciar Projeto", description = "Método para iniciar um projeto!")
    ...
    @Operation(summary = "Atualizar um Projeto", description = "Método para iniciar um projeto!")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Deletar um Projeto", description = "Método para deleta um projeto por Id!")
